(() => {
    ...
    */
    ...
    const subtraction = calculator(20, 20)
    const multiplication = calculator(20, 20)
    const division = calculator(20, 20)
    const mod = calculator(20, 20)
