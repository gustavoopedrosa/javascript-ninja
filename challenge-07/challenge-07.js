...
const arr = ['gustavo', true, null, [1 , 2], { ninja: 'fernando'}]
...
console.log(addItem(['string', 5, function(){}]))
...
console.log(`O segundo elemento do segundo array é ${arr[5][1]}.`) // O segundo elemento do segundo array é 5.
