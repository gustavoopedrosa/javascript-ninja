...
*/
  ...
  console.log("O array em formato de string é:", array.join(", "));
...
*/
  brasil.unshift("Pará", "Pernambuco", "Ceará");
...
*/
  //   const newSul = brasil.filter((item) => {
  //     return (
  //       item === "santa catarina" ||
  //       item === "parana" ||
...
*/
  const sevenLetters = brasil.every((item) => {
    return item.length > 7;
  });

  console.log(
    "\nTodos os estados de `brasil` tem mais de 7 letras?",
    sevenLetters ? "Sim" : "Não"
  );
  /*
...
*/
  const containCeara = brasil.some((item) => {
    return item === "Ceará";
  });

  console.log(
    "\nCeará está incluído em `brasil`?",
    containCeara ? "Sim" : "Não"
  );
  /*
...
*/
  console.log("\nnewBrasil agora com mais informações:", newNewBrasil);
  // ?
...
*/
  //   const filter = newNewBrasil.filter((item) => {
  //     if (item.id % 2 === 0) {
  //       return item;
  //     }
  //   });
